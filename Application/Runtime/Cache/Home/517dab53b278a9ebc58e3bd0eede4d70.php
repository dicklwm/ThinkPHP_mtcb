...
<div class="container">
    ...
    <a href="<?php echo U('Workflow/leaveTask',array('id'=>'1'));?>" class="list-group-item"><span class="badge">新</span>
        <h4 class="list-group-item-heading">
        <p>(休)请假申请流程</p>
            <p>2016-07-14 11：03：03</p>
        </h4>
    </a>
    <a href="#" class="list-group-item"><span class="badge">新</span>
        <h4 class="list-group-item-heading">
            <p>出差申请流程</p>
            <p>2016-07-14 11：03：03</p>
        </h4>
